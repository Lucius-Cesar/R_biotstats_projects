...
subtitle: "Différence entre la masse des gonades des *P.lividus* sauvages et d' echiniculture"
author:
...
![Photographie de *Paracentrotus lividus*](../image/Paracentrotus_lividus_Banyuls.jpg)
...
-> L'hypothèse \(H_{0}\) : \(\mu_{sauvage} = \mu_{élevage}\) est rejetée
